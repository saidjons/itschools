...
@section('body')
 <div id="page" class="theia-exception mm-page mm-slideout">
	...
	<main style="transform: none;">
		<section id="hero_in" class="courses start_bg_zoom">
			<div class="wrapper">
				<div class="container">
					<h1 class="fadeInUp animated"><span></span>Online course detail</h1>
				</div>
			</div>
		</section>
		<!--/hero_in-->
		...
		<div class="bg_color_1" style="transform: none;">
			...
			<div class="container margin_60_35" style="transform: none;">
				<div class="row" style="transform: none;">
					...
					<div class="theiaStickySidebar" style="padding-top: 0px; padding-bottom: 1px; position: static; transform: none; left: 907.778px; top: 0px;"><div class="box_detail">
							<figure>
